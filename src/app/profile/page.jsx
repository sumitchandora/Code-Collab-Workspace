...
import { collection, doc, getDoc, setDoc, onSnapshot,updateDoc, arrayRemove, arrayUnion } from "firebase/firestore";
...
const Profile = () => {
    ...
    const handleAcceptInvite = async (workspaceId) => {
        ...
        try {
            const membersRef = doc(db, `workspaces/${workspaceId}/members`, user.email);
