...
const Workspace = () => {
    ...
    return (
        <div className="flex flex-col h-screen w-screen bg-gradient-to-br from-gray-950 via-purple-950 to-purple-900 text-white min-w-[1024px] relative">
            ...
            {/* Chat Toggle Button */}
            {
                !isChatOpen && (
                    <button
                        className="fixed bottom-6 right-10 z-30 py-3 font-mono px-5 flex items-center gap-2 text-xl bg-blue-700/30 ring-1 ring-blue-500  hover:bg-blue-800 text-white rounded-full shadow-lg"
